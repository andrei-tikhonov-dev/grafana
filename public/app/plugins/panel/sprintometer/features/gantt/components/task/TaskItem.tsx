...
import { MTaskItemProps } from '../../types';

/**
 * TaskItem Component - Renders an individual task bar in the Gantt chart
 */
const TaskItem: React.FC<MTaskItemProps> = ({
  task,
  leftPx,
  widthPx,
  topPx,
  ...
  const handleProgressMouseMove = useCallback(
    (e: MouseEvent) => {
      if (!isDraggingProgress || !taskRef.current) {
        return;
      }
  ...
  }, [isDraggingProgress, onProgressUpdate, progressPercent, task, handleProgressMouseMove]);
