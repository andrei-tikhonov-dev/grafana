...
export class CollisionService {
   ...
   */
  public static detectOverlaps(tasks: MTask[], viewMode: EViewMode = EViewMode.MONTH): MTask[][] {
   ...
   */
  public static tasksVisuallyOverlap(taskA: MTask, taskB: MTask, viewMode: EViewMode = EViewMode.MONTH): boolean {
   ...
   */
  private static getCollisionBufferByViewMode(viewMode: EViewMode): number {
