...
import { EDateDisplayFormat, EViewMode } from '../types';
...
export function formatDate(
  date: Date,
  format: EDateDisplayFormat = EDateDisplayFormat.FULL_DATE,
  locale = 'default'
): string {
...
export function formatDateRange(startDate: Date, endDate: Date, locale = 'default'): string {
  ...
  const start = formatDate(startDate, EDateDisplayFormat.SHORT_DATE, locale);
  const end = formatDate(endDate, EDateDisplayFormat.SHORT_DATE, locale);
