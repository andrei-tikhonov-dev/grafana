...
import { MTaskGroup } from '../../../features/gantt/types';
...
// Basic demo data
export const basicDemoData: MTaskGroup[] = [
  {
    id: 'team-1',
    name: 'Engineering',
...
export const complexDemoData: MTaskGroup[] = [
  {
    id: 'team-development',
    name: 'Development',
...
export const yearLongProjectData: MTaskGroup[] = [
  {
    id: 'phase-planning',
    name: 'Planning Phase',
