...
import { UiExpandableTable, renderCellContent, UiTypography } from '../../components/ui';
...
export const OutgoingDependencies: React.FC<Props> = ({ width, height, data: panelData }) => {
  const { total, columns, innerColumns, data } = getGrafanaCustomData<OutgoingArtDependenciesCustomData>(
    panelData,
    initialData
  );
